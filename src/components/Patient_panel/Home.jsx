// Enhanced Home.jsx with Additional Animations
...
const Home = () => {
  ...
  return (
    <div className="page-container">
      ...
      <section
        id="home"
        className="hero-section bounce-in"
        style={{ backgroundImage: `url(${backImg})` }}
      >
        <div className="hero-overlay">
          <div className="hero-content animated-fade-in">
            <h1 className="animated-slide-up hero-title zoom-in">
              Welcome to <span className="highlight">MediTrack</span>
            </h1>
            <p className="hero-text animated-slide-up delay-1 fade-in-up">
            ...
            <p className="hero-text animated-slide-up delay-2 fade-in-up">
              Manage your appointments, prescriptions, and records seamlessly from anywhere.
            </p>
            <p className="hero-text animated-slide-up delay-3 fade-in-up">
      ...
      {/* Stats Section */}
      <section className="stats-section zoom-fade-in pulse">
        <div className="stat-card bounce-in"><h3>10K+</h3><p>Active Patients</p></div>
        <div className="stat-card bounce-in"><h3>500+</h3><p>Healthcare Providers</p></div>
        <div className="stat-card bounce-in"><h3>98%</h3><p>Patient Satisfaction</p></div>
        <div className="stat-card bounce-in"><h3>24/7</h3><p>Support</p></div>
      </section>

      {/* About Section */}
      <section id="about" className="about-section fade-in-up">
        <div className="about-container">
          <div className="about-image slide-in-left zoom-in">
            <img src={doctorImage} alt="Doctor" />
          </div>
          <div className="about-content slide-in-right">
            <h2>About <span className="highlight">MediTrack</span></h2>
            <p className="fade-in-up">MediTrack is your trusted partner in digital healthcare transformation.</p>
            <p className="fade-in-up">We provide secure, seamless, and smart access to appointments, prescriptions, and medical history.</p>
            <p className="fade-in-up">Built for hospitals, doctors, and patients—so you stay connected and in control.</p>
            <p className="fade-in-up">Experience healthcare, simplified.</p>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="services-section animated-section">
        <h2 className="fade-in-up delay-1 slide-in-up">Services</h2>
        <div className="services-grid">
          {[
            ...
            <div key={i} className={`service-card zoom-in slide-in-up delay-${1 + i}`}>
          ...
          {[
            ...
            <div key={i} className={`service-card zoom-in slide-in-up delay-${1 + i}`}>
              <div className="service-icon">
                <img src={d.img} alt={d.name} className="doctor-thumb fade-in" />
              </div>
              <h3>{d.name}</h3>
              <p className="specialty">{d.specialty}</p>
              <p className="desc fade-in-up">{d.desc}</p>
              <button className="doctor-btn fade-in" onClick={() => handleFeatureClick(`Book with ${d.name}`)}>
                Book Now
              </button>
            </div>
          ))}
      ...
      {/* Contact Section */}
      <section id="contact" className="contact-section slide-in-up">
        <div className="contact-container">
          <div className="contact-details slide-in-left delay-1 fade-in">
          ...
          <div className="contact-map slide-in-right delay-2 zoom-in">
            <iframe
      ...
      <section id="feedback" className="feedback-section fade-in-up">
        <div className="feedback-container bounce-in">
          <h2 className="section-title">Feedback</h2>
          <p>We value your feedback! Please share your thoughts with us.</p>
          <form className="feedback-form slide-in-up" onSubmit={(e) => {
            e.preventDefault();
